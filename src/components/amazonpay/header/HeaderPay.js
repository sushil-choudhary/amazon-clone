    ...
    <div>
      <div className="headerPay">
        ...
        <div className="navPay">
          <Link>
            <p className="navPay1">For businesses</p>
          </Link>
          <Link>
            <p className="navPay2">For shoppers</p>
          </Link>
          <Link>
            <p className="navPay3">How it works</p>
          </Link>
          <Link>
            <p className="navPay4">Insights</p>
          </Link>
          <Link>
            <p className="navPay5">Getting started</p>
          </Link>
        </div>
      </div>
    </div>
